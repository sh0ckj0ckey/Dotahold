            ...
            try
            {
                ...
                switch (tier)
                {
                    case 1:
                        ...
                        {
                            _tierColors[1] = new SolidColorBrush(Color.FromArgb(255, 83, 83, 83));
                        }
                        return _tierColors[1];
                    case 2:
                        if (!_tierColors.TryGetValue(2, out _))
                        {
                            _tierColors[2] = new SolidColorBrush(Color.FromArgb(255, 0, 89, 0));
                        }
                        return _tierColors[2];
                    case 3:
                        if (!_tierColors.TryGetValue(3, out _))
                        {
                            _tierColors[3] = new SolidColorBrush(Color.FromArgb(255, 35, 35, 178));
                        }
                        return _tierColors[3];
                    case 4:
                        if (!_tierColors.TryGetValue(4, out _))
                        {
                            _tierColors[4] = new SolidColorBrush(Color.FromArgb(255, 102, 0, 102));
                        }
                        return _tierColors[4];
                    case 5:
                        if (!_tierColors.TryGetValue(5, out _))
                        {
                            _tierColors[5] = new SolidColorBrush(Color.FromArgb(255, 255, 165, 0));
                        }
