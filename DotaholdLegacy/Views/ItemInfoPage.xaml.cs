...
namespace Dotahold.Views
{
    ...
    public sealed partial class ItemInfoPage : Page, INotifyPropertyChanged
    {
        ...
        // 当前物品的配方列表
        private ObservableCollection<Data.Models.DotaItemModel> vComponentsList = new ObservableCollection<Data.Models.DotaItemModel>();
        ...
        private void OnClickComponents(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    if (e.ClickedItem is Data.Models.DotaItemModel item)
                    {
