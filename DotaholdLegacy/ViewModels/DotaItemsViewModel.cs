...
namespace Dotahold.ViewModels
{
    public class DotaItemsViewModel : ViewModelBase
    {
        ...
        // 所有物品
        public Dictionary<string, Data.Models.DotaItemModel> dictNameToAllItems { get; set; } = new Dictionary<string, Data.Models.DotaItemModel>();
        public Dictionary<string, Data.Models.DotaItemModel> dictIdToAllItems { get; set; } = new Dictionary<string, Data.Models.DotaItemModel>();

        private List<Data.Models.DotaItemModel> _vAllItems { get; set; } = new List<Data.Models.DotaItemModel>();

        // 列表展示的物品
        public ObservableCollection<Data.Models.DotaItemModel> vAllShowItemsList { get; set; } = new ObservableCollection<Data.Models.DotaItemModel>();

        // 搜索时展示的物品
        public ObservableCollection<Data.Models.DotaItemModel> vSearchItemsList { get; set; } = new ObservableCollection<Data.Models.DotaItemModel>();
        ...
        // 当前选中的物品
        private Data.Models.DotaItemModel _CurrentItem = null;
        public Data.Models.DotaItemModel CurrentItem
        {
